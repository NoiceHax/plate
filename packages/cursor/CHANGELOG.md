...
- [#5036](https://github.com/udecode/plate/pull/5036) by [@zbeyens](https://github.com/zbeyens) – Accept Plite `DOMEditor` and text selections in cursor geometry helpers. Own
  generic cursor overlay state, positioning, resize refresh, and minimum-width
  normalization in `@platejs/cursor`.
