...
- [#5036](https://github.com/udecode/plate/pull/5036) by [@zbeyens](https://github.com/zbeyens) – Publish AI behavior through explicit services, snapshot reads, selectors, and
