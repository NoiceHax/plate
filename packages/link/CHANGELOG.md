...
- [#5036](https://github.com/udecode/plate/pull/5036) by [@zbeyens](https://github.com/zbeyens) – Export `BaseLinkPluginState` and `LinkPluginState` as the complete mutable
